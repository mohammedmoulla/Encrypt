...
public class Key {
  ...
  public  Key  (String temp ) {
       K = new Binary[9];
        ...
        ///////////////////////////
        String s ="" ;
        if (temp.length()<8){   //key is less than 128 bit 
        ...
        else if (temp.length()>8) { //key is larger than 128 bit
           
            for (int i=0; i<8; i++)
              s+=temp.charAt(i);
        }else { //key is beautiful
            s=temp;
        }
        ////////////////////////////
